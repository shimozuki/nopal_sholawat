            ...
            FutureBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Center(
                      child: Text("Koneksi Error! Periksa internet anda"));
                  ...
                  return Center(child: Text("Koneksi Error, Mohon Coba lagi!"));
                }
              },
            ),
          ],
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text("Sajda Number: ${widget.sajdaNumber}",
                    style: TextStyle(color: Color(0xFFE8FCE8))),
                ...
                SizedBox(
                  ...
                  child: TextButton(
                      style: TextButton.styleFrom(
                        foregroundColor: Color(0xFF4A7D58),
                      ),
